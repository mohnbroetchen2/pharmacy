...
urlpatterns = [
    ...
    path('mix/selectordersformixedpharmacy', pharmadoc.views.selectordersformixedpharmacy, name='selectordersformixedpharmacy'),
    path('mix/mixedsolutions', pharmadoc.views.mixed_solutions, name='overview mixed solution'),
    path('mix/initmixedsolution', pharmadoc.views.initmixedsolution, name='initmixedsolution'),
    path('mix/addmixedsolution', pharmadoc.views.addmixedsolution, name='addmixedsolution'),
    path('mix/submit/<int:primary_key>', pharmadoc.views.mixedsubmit_view, name='mixedsubmitview'),
    path('mix/submit/createsubmission', pharmadoc.views.mixedcreatesubmission, name='mixedcreatesubmission'),
